...
export default function SubscriptionHero() {
  ...
  return (
    <section aria-labelledby="subscription-hero-heading" className="relative w-full bg-white text-[#082219] py-16 md:py-24 border-b border-gray-100 overflow-hidden font-sans selection:bg-[#C5A059] selection:text-white">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10 flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
        ...
        <div className="w-full lg:w-[40%] flex flex-col justify-center text-left relative z-20">
          ...
          <a href="#plans" className="group inline-flex items-center w-max gap-3 bg-[#082219] text-[#C5A059] px-8 py-4 rounded-xl text-xs md:text-[13px] font-black uppercase tracking-widest hover:bg-[#C5A059] hover:text-[#082219] transition-all shadow-[0_8px_20px_rgba(8,34,25,0.2)] hover:shadow-[0_12px_24px_rgba(197,160,89,0.3)]">
            View Plans
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6 relative z-10" role="list">
            ...
            {steps.map((step) => (
              <div 
                key={step.id}
                role="listitem"
                className="exec-card group flex flex-row md:flex-col items-center md:items-start p-6 md:p-8 rounded-[1.5rem] border border-gray-100 shadow-[0_4px_15px_rgba(0,0,0,0.02)] cursor-default overflow-hidden relative"
              >
