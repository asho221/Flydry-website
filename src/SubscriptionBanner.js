...
export default function App() {
  ...
  return (
    <div className="w-full flex flex-col items-center bg-[#fdfdfd]">
      ...
      {/* 2. THE SUBSCRIPTION WIDGET EMBED */}
      {/* Cleaned up styling to prevent breaking the layout width */}
      <div id="subscription-plans" className="w-full max-w-[1400px] mx-auto pt-16 md:pt-24 pb-12 px-2 sm:px-4">
        <iframe 
